...
#     cutoff_index = int(len(sorted_indices) * percentage)
...
def main():
    ...
    result_file_path = '../result/Bert_sim_result/metrics.xlsx'
    percentages = np.arange(0.01, 1.01, 0.01)  # 百分比范围从 1% 到 100%

    metrics = {}

    for dataset in datasets:
        file_path = f'../result/Bert_vec_result/{dataset}/{dataset}_bert_vectors.xlsx'
